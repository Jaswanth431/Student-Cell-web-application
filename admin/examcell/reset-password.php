        ...
        <main>
            ...
            <div class="content-box">
                ...
                <form action="reset-password.php" method="POST">
                    <input type="password" name="password1" class="input-element mb-1 margin-right" placeholder="Enter Password.."/>
                    <input type="password" name="password2" class="input-element mb-1 margin-right" placeholder="Re Enter Password.."/>
