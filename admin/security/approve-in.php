    ...
    <body>
        ...
        <main>
            ...
            <div class="content-box">
                ...
                <h1 class="heading-primary heading-underline"><i class="fa fa-hand-o-right" aria-hidden="true"></i>Approve IN</h1>
                <div class="response-box">
                </div>
                <div class="out-of-campus-list-box">
                    <input type="text" id="student_id" class="input-element" placeholder="Enter student ID...">
                </div>
                <div class="out-of-campus-list">
                </div>
            </div>
        </main>
